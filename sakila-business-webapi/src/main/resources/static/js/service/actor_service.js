...
App.factory('ActorService', ['$http', '$q', function ($http, $q) {
        return {
            fetchAllActors: function () {
                return $http.get('http://localhost:8080/actor/').then(function (response) {
            ...
            createActor: function (actor) {
                return $http.post('http://localhost:8080/actor/', actor).then(function (response) {
                    return response.data;
                }, function (errResponse) {
            ...
            updateActor: function (actor, actorId) {
                ...
                return $http.post('http://localhost:8080/actorUpdate/', actor).then(function (response) {
                    return response.data;
                }, function (errResponse) {
            ...
            deleteActor: function (actorId) {
                return $http.get('http://localhost:8080/actorDelete/' + actorId).then(function (response) {
                    return response.data;
                }, function (errResponse) {
